...
def calc_energy(t, n):
    ...
    if d <= D0:
        ...
        ew = Emp
        f = F_IN_MULTIPATH
    #traffic relayed for the subtree: sum of the packets generated by every
    #descendant, so heterogeneous g(i) maps are accounted correctly
    relayed = 0.0
    for i in n.receive_from:
        relayed += t.nodes[i].g_i_
